# E3T2 — Configure logging and environment variables

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TIP

Set up structured logging to stdout with INFO for normal operations and ERROR for failures. Configure the bot to read the TIPBOT_DB environment variable for the database file path (default ./tipbot.db). This task does not require a dialog spec or command registration.
