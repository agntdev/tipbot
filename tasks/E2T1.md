# E2T1 — Handle unknown commands and messages

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TIP

Reply with a short help hint for unknown messages: 'Use /tip for a kind tip, /count to see how many tips have been served.' This task does not require a dialog spec or command registration.
