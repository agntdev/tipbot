# E2T2 — Implement error handling for database operations

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TIP

Catch and handle database read/write errors, replying with 'Sorry — something went wrong. Try again later.' and logging the error. This task does not require a dialog spec or command registration.
