# E3T1 — Validate bot token on startup

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TIP

Check that the TELEGRAM_BOT_TOKEN environment variable is present and valid. Exit with a clear error message if missing or invalid. This task does not require a dialog spec or command registration.
