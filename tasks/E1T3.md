# E1T3 — Initialize and manage SQLite database for tip counter

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TIP

Create the SQLite database and counters table if missing, ensure 'tips_served' key exists with a default value of 0. Set WAL mode for concurrency. This task does not require a dialog spec or command registration.
