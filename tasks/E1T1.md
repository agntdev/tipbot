# E1T1 — Implement /tip command with random tip selection

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TIP

Select a random tip from the built-in list of 8 tips, increment the global counter in persistent storage, and reply with the tip text. Write the dialog spec to tests/specs/E1T1.json and append the command to tests/commands.json.
