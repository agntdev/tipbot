# E1T2 — Implement /count command to display total tips served

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TIP

Read the persisted global counter and reply with the total number of tips served. Write the dialog spec to tests/specs/E1T2.json and append the command to tests/commands.json.
